    ...
    public:
        ...
        struct boss_nalorakkAI : public ScriptedAI
        {
            ...
            void Reset() OVERRIDE
            {
                ...
                inBearForm = false;
                // me->SetUInt32Value(UNIT_VIRTUAL_ITEM_SLOT_DISPLAY + 1, 5122);  /// @todo find the correct equipment id
            }
            ...
            void SendAttacker(Unit* target)
            {
...

                {
                    ...
                    Infinity::AllFriendlyCreaturesInGrid check(me);
                    Infinity::CreatureListSearcher<Infinity::AllFriendlyCreaturesInGrid> searcher(me, templist, check);

                    TypeContainerVisitor<Infinity::CreatureListSearcher<Infinity::AllFriendlyCreaturesInGrid>, GridTypeMapContainer> cSearcher(searcher);
