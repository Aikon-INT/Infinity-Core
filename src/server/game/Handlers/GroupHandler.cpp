...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_INVITE");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ACCEPT");
    ...
    {
        IC_LOG_ERROR("network", "HandleGroupAcceptOpcode: player %s(%d) tried to accept an invite to his own group", GetPlayer()->GetName().c_str(), GetPlayer()->GetGUIDLow());
        return;
    }
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DECLINE");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE_GUID");
    ...
    {
        IC_LOG_ERROR("network", "WorldSession::HandleGroupUninviteGuidOpcode: leader %s(%d) tried to uninvite himself from the group.",
...
void WorldSession::HandleGroupUninviteNameOpcode(WorldPacket& recvData)
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_UNINVITE");
    ...
    {
        IC_LOG_ERROR("network", "WorldSession::HandleGroupUninviteOpcode: leader %s(%d) tried to uninvite himself from the group.",
            GetPlayer()->GetName().c_str(), GetPlayer()->GetGUIDLow());
        return;
    }
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_SET_LEADER");
...
void WorldSession::HandleGroupLeaveOpcode(WorldPacket & /*recvData*/)
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_DISBAND");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_LOOT_METHOD");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received MSG_MINIMAP_PING");
    ...
    //IC_LOG_DEBUG("Received opcode MSG_MINIMAP_PING X: %f, Y: %f", x, y);
...
{
    IC_LOG_DEBUG("network", "WORLD: Received MSG_RANDOM_ROLL");
    ...
    //IC_LOG_DEBUG("ROLL: MIN: %u, MAX: %u, ROLL: %u", minimum, maximum, roll);
...
{
    IC_LOG_DEBUG("network", "WORLD: Received MSG_RAID_TARGET_UPDATE");
...
/*
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_RAID_CONVERT");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_CHANGE_SUB_GROUP");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_GROUP_ASSISTANT_LEADER");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received MSG_PARTY_ASSIGNMENT");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received MSG_RAID_READY_CHECK");
...
void WorldSession::HandleRaidReadyCheckFinishOpcode(WorldPacket & /*recvData*/)
{
    //Group* group = GetPlayer()->GetGroup();
    //if (!group)
    //    return;
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_REQUEST_PARTY_MEMBER_STATS");
    uint64 Guid;
    recvData >> Guid;
...
{
    IC_LOG_DEBUG("WORLD: got CMSG_GROUP_CANCEL.");
}*/

void WorldSession::HandleGroupPassOnLootOpcode(WorldPacket& recvData)
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_OPT_OUT_OF_LOOT");
    ...
    {
        if (passOnLoot != 0)
            IC_LOG_ERROR("network", "CMSG_OPT_OUT_OF_LOOT value<>0 for not-loaded character!");
        return;
    }
