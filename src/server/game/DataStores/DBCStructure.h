...
#ifndef INFINITY_DBCSTRUCTURE_H
#define INFINITY_DBCSTRUCTURE_H
...
/* fix me or add me to InfinityDBC database.
...
{
    uint32     ID;                                          // 0
    int32      SpellID[TOTAL_DIFFICULTIES];                     // 1-4 instance modes: 10N, 25N, 10H, 25H or Normal/Heroic if only 1-2 is set, if 3-4 is 0 then Mode-2
};
