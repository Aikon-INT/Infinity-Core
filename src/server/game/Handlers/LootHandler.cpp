...
{
    IC_LOG_DEBUG("network", "WORLD: CMSG_AUTOSTORE_LOOT_ITEM");
...
{
    IC_LOG_DEBUG("network", "WORLD: CMSG_LOOT_MONEY");
...
{
    IC_LOG_DEBUG("network", "WORLD: CMSG_LOOT");
...
{
    IC_LOG_DEBUG("network", "WORLD: CMSG_LOOT_RELEASE");
...
void WorldSession::HandleLootMasterGiveOpcode(WorldPacket& recvData)
{
    ...
    IC_LOG_DEBUG("network", "WorldSession::HandleLootMasterGiveOpcode (CMSG_LOOT_MASTER_GIVE, 0x02A3) Target = [%s].", target->GetName().c_str());
    ...
    if (IS_CRE_GUID(GetPlayer()->GetLootGUID()))
    {
    ...
    {
        IC_LOG_DEBUG("loot", "MasterLootItem: Player %s might be using a hack! (slot %d, size %lu)",
