...
public:
    ...
    struct instance_blackrock_depths_InstanceMapScript : public InstanceScript
    {
        ...
        {
            IC_LOG_DEBUG("scripts", "Instance Blackrock Depths: SetData64 update (Type: %u Data " UI64FMTD ")", type, data);
        ...
        {
            IC_LOG_DEBUG("scripts", "Instance Blackrock Depths: SetData update (Type: %u Data %u)", type, data);
