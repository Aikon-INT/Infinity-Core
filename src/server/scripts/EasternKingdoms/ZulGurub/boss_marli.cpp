...
class boss_marli : public CreatureScript
{
    public: boss_marli() : CreatureScript("boss_marli") { }
        ...
        struct boss_marliAI : public BossAI
        {
            ...
            {
                _EnterCombat();
                events.ScheduleEvent(EVENT_SPAWN_START_SPIDERS, 1000, 0);
                Talk(SAY_AGGRO);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SPAWN_START_SPIDERS:
                            ...
                            events.ScheduleEvent(EVENT_ASPECT_OF_MARLI, 12000, 0);
                            events.ScheduleEvent(EVENT_TRANSFORM, 45000, 0);
                        ...
                        case EVENT_ASPECT_OF_MARLI:
                            ...
                            events.ScheduleEvent(EVENT_ASPECT_OF_MARLI, urand(13000, 18000), 0);
                            break;
                        ...
                        case EVENT_TRANSFORM:
                        {
                            ...
                            events.ScheduleEvent(EVENT_CHARGE_PLAYER, 1500, 0);
                            events.ScheduleEvent(EVENT_TRANSFORM_BACK, 25000, 0);
                            break;
                        }
                        case EVENT_CHARGE_PLAYER:
                        {
                            ...
                            events.ScheduleEvent(EVENT_CHARGE_PLAYER, 8000, 0);
                            break;
                        }
                        case EVENT_TRANSFORM_BACK:
                        {
                            ...
                            events.ScheduleEvent(EVENT_POISON_VOLLEY, 15000);
                            events.ScheduleEvent(EVENT_SPAWN_SPIDER, 30000);
                            events.ScheduleEvent(EVENT_TRANSFORM, urand(35000, 60000), 0);
                            break;
                        }
                        default:
                            break;
