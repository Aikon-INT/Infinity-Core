...
class boss_arlokk : public CreatureScript
{
    public: boss_arlokk() : CreatureScript("boss_arlokk") { }
        ...
        struct boss_arlokkAI : public BossAI
        {
            ...
            {
                _EnterCombat();
                events.ScheduleEvent(EVENT_SHADOW_WORD_PAIN, urand(7000, 9000), 0);
                events.ScheduleEvent(EVENT_GOUGE, urand(12000, 15000), 0);
                if (instance)
                    events.ScheduleEvent(EVENT_SUMMON_PROWLERS, 6000, 0);
                events.ScheduleEvent(EVENT_MARK_OF_ARLOKK, urand(9000, 11000), 0);
                events.ScheduleEvent(EVENT_TRANSFORM, urand(15000, 20000), 0);
                Talk(SAY_AGGRO);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SHADOW_WORD_PAIN:
                            ...
                            events.ScheduleEvent(EVENT_SHADOW_WORD_PAIN, urand(5000, 7000), 0);
                            break;
                        case EVENT_GOUGE:
                        ...
                        case EVENT_TRANSFORM:
                        {
                            ...
                            events.ScheduleEvent(EVENT_VANISH, 1000, 0);
                            break;
                        }
                        case EVENT_VANISH:
                            ...
                            events.ScheduleEvent(EVENT_VANISH_2, 9000, 0);
                            break;
                        case EVENT_VANISH_2:
                            DoCast(me, SPELL_VANISH);
                            DoCast(me, SPELL_SUPER_INVIS);
                            events.ScheduleEvent(EVENT_VISIBLE, urand(7000, 10000), 0);
                            break;
                        case EVENT_VISIBLE:
                            ...
                            events.ScheduleEvent(EVENT_RAVAGE, urand(10000, 14000), 0);
                            events.ScheduleEvent(EVENT_TRANSFORM_BACK, urand(15000, 18000), 0);
                            break;
                        case EVENT_RAVAGE:
                        ...
                        case EVENT_TRANSFORM_BACK:
                        {
                            ...
                            me->UpdateDamagePhysical(BASE_ATTACK);
                            events.ScheduleEvent(EVENT_SHADOW_WORD_PAIN, urand(4000, 7000), 0);
                            events.ScheduleEvent(EVENT_GOUGE, urand(12000, 15000), 0);
                            events.ScheduleEvent(EVENT_TRANSFORM, urand(16000, 20000), 0);
                            break;
                        }
                        default:
                            break;
