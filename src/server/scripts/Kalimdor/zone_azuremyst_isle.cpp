...
public:
    ...
    struct npc_geezleAI : public ScriptedAI
    {
        ...
        void CompleteQuest()
        {
            ...
            Infinity::AnyPlayerInObjectRangeCheck checker(me, radius);
            Infinity::PlayerListSearcher<Infinity::AnyPlayerInObjectRangeCheck> searcher(me, players, checker);
        ...
        void DespawnNagaFlag(bool despawn)
        {
            ...
            if (!FlagList.empty())
            {
                ...
                IC_LOG_ERROR("scripts", "SD2 ERROR: FlagList is empty!");
        }
