...
void WardenMac::Init(WorldSession* pClient, BigNumber* K)
{
    ...
    */
    ...
    IC_LOG_DEBUG("warden", "Server side warden for client %u initializing...", pClient->GetAccountId());
...
void WardenMac::HandleData(ByteBuffer &buff)
{
    ...
    {
        IC_LOG_DEBUG("warden", "Handle data failed: SHA1 hash is wrong!");
        //found = true;
    }
    ...
    {
        IC_LOG_DEBUG("warden", "Handle data failed: MD5 hash is wrong!");
        //found = true;
    }
