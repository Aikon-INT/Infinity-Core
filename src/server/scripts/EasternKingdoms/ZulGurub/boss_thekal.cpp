...
class boss_thekal : public CreatureScript
{
    public: boss_thekal() : CreatureScript("boss_thekal") { }
        ...
        struct boss_thekalAI : public BossAI
        {
            ...
            {
                _EnterCombat();
                events.ScheduleEvent(EVENT_MORTALCLEAVE, 4000, 0);     // Phase 1
                events.ScheduleEvent(EVENT_SILENCE, 9000, 0);          // Phase 1
                events.ScheduleEvent(EVENT_CHECK_TIMER, 10000, 0);     // Phase 1
                events.ScheduleEvent(EVENT_RESURRECT_TIMER, 10000, 0); // Phase 1
                Talk(SAY_AGGRO);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_MORTALCLEAVE:
                            ...
                            events.ScheduleEvent(EVENT_MORTALCLEAVE, urand(15000, 20000), 0);
                            break;
                        case EVENT_SILENCE:
                            DoCastVictim(SPELL_SILENCE, true);
                            events.ScheduleEvent(EVENT_SILENCE, urand(20000, 25000), 0);
                            break;
                        case EVENT_RESURRECT_TIMER:
                            ...
                            if (WasDead)
                            {
                                ...
                                DoResetThreat();
                                events.ScheduleEvent(EVENT_FRENZY, 30000, 0);          // Phase 2
                                events.ScheduleEvent(EVENT_FORCEPUNCH, 4000, 0);       // Phase 2
                                events.ScheduleEvent(EVENT_SPELL_CHARGE, 12000, 0);    // Phase 2
                                events.ScheduleEvent(EVENT_ENRAGE, 32000, 0);          // Phase 2
                                events.ScheduleEvent(EVENT_SUMMONTIGERS, 25000, 0);    // Phase 2
                            }
                            events.ScheduleEvent(EVENT_RESURRECT_TIMER, 10000, 0);
                            break;
                        case EVENT_CHECK_TIMER:
                            ...
                            events.ScheduleEvent(EVENT_CHECK_TIMER, 5000, 0);
                            break;
                        case EVENT_FRENZY:
                            DoCast(me, SPELL_FRENZY);
                            events.ScheduleEvent(EVENT_FRENZY, 30000, 0);
                            break;
                        case EVENT_FORCEPUNCH:
                            DoCastVictim(SPELL_FORCEPUNCH, true);
                            events.ScheduleEvent(EVENT_FORCEPUNCH, urand(16000, 21000), 0);
                            break;
                        case EVENT_CHARGE:
                            ...
                            events.ScheduleEvent(EVENT_CHARGE, urand(15000, 22000), 0);
                            break;
                        case EVENT_ENRAGE:
                        ...
                        case EVENT_SUMMONTIGERS:
                            ...
                            events.ScheduleEvent(EVENT_SUMMONTIGERS, urand(10000, 14000), 0);
                            break;
                        default:
                            break;
                    }
