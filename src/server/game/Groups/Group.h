...
enum GroupMemberOnlineStatus
{
    ...
    MEMBER_STATUS_UNK3      = 0x0020,                       // used in calls from Lua_GetPlayerMapPosition
...
class Group
{
    ...
    public:
        ...
        void SendLootStartRollToPlayer(uint32 countDown, uint32 mapId, Player* p, Roll const& r);
