...
{
    IC_LOG_DEBUG("network", "MSG_INSPECT_ARENA_TEAMS");

    uint64 guid;
    recvData >> guid;
    IC_LOG_DEBUG("network", "Inspect Arena stats (GUID: %u TypeId: %u)", GUID_LOPART(guid), GuidHigh2TypeId(GUID_HIPART(guid)));
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_QUERY");
...
{
    IC_LOG_DEBUG("network", "WORLD: Received CMSG_ARENA_TEAM_ROSTER");
...
void WorldSession::HandleArenaTeamAddMemberOpcode(WorldPacket& recvData)
{
    IC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_INVITE");
    ...
    IC_LOG_DEBUG("bg.battleground", "Player %s Invited %s to Join his ArenaTeam", GetPlayer()->GetName().c_str(), invitedName.c_str());
    ...
    IC_LOG_DEBUG("network", "WORLD: Sent SMSG_ARENA_TEAM_INVITE");
}

void WorldSession::HandleArenaTeamInviteAcceptOpcode(WorldPacket & /*recvData*/)
{
    IC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_ACCEPT");                // empty opcode
...
void WorldSession::HandleArenaTeamInviteDeclineOpcode(WorldPacket & /*recvData*/)
{
    IC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DECLINE");               // empty opcode
...
{
    IC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEAVE");
...
{
    IC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_DISBAND");
...
void WorldSession::HandleArenaTeamRemoveFromTeamOpcode(WorldPacket& recvData)
{
    IC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_REMOVE");
...
void WorldSession::HandleArenaTeamPromoteToCaptainOpcode(WorldPacket& recvData)
{
    IC_LOG_DEBUG("network", "CMSG_ARENA_TEAM_LEADER");
