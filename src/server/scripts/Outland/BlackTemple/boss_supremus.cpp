            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_HATEFUL_STRIKE:
                        ...
                        events.ScheduleEvent(EVENT_HATEFUL_STRIKE, 5000, GCD_CAST);
                        break;
                    case EVENT_SWITCH_TARGET:
                        ...
                        events.ScheduleEvent(EVENT_SWITCH_TARGET, 10000, 0);
                        break;
                    case EVENT_VOLCANO:
                    {
                        ...
                        events.ScheduleEvent(EVENT_VOLCANO, 10000, GCD_CAST);
                        return;
                    }
