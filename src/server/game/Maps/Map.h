...
#ifndef INFINITY_MAP_H
#define INFINITY_MAP_H
...
class InstanceMap;
class Transport;
namespace Infinity { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<Infinity::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<Infinity::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(Infinity::ComputeGridCoord(x, y));
        }
        ...
        bool IsHeroic() const { return IsRaid() ? i_spawnMode >= RAID_DIFFICULTY_HEROIC : i_spawnMode >= DUNGEON_DIFFICULTY_HEROIC; }
        ...
        TempSummon* SummonCreature(uint32 entry, Position const& pos, SummonPropertiesEntry const* properties = NULL, uint32 duration = 0, Unit* summoner = NULL, uint32 spellId = 0);
