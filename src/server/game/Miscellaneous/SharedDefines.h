...
#ifndef INFINITY_SHAREDDEFINES_H
#define INFINITY_SHAREDDEFINES_H
...
enum CreatureTypeFlags
{
    ...
    CREATURE_TYPEFLAGS_UNK17            = 0x00020000,         // ? Related to pvp?
    CREATURE_TYPEFLAGS_UNK18            = 0x00040000,         // ? Related to siege weapons?
...
enum DungeonStatusFlag
{
    ...
    RAID_STATUSFLAG_NORMAL = 0x01,
    //RAID_STATUSFLAG_25MAN_NORMAL = 0x02,
    RAID_STATUSFLAG_HEROIC = 0x04
...
#define EXPECTED_INFINITYCORE_CLIENT_BUILD        {9947, 0}
