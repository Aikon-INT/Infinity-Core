    ...
    public: boss_venoxis() : CreatureScript("boss_venoxis") { }
        ...
        struct boss_venoxisAI : public BossAI
        {
            ...
            void EnterCombat(Unit* /*who*/) OVERRIDE
            {
                ...
                events.ScheduleEvent(EVENT_HOLY_NOVA, 5000, 0);
                events.ScheduleEvent(EVENT_DISPEL_MAGIC, 35000, 0);
                events.ScheduleEvent(EVENT_HOLY_FIRE, 10000, 0);
                events.ScheduleEvent(EVENT_RENEW, 30000, 0);
                events.ScheduleEvent(EVENT_HOLY_WRATH, 60000, 0);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_DISPEL_MAGIC:
                            ...
                            events.ScheduleEvent(EVENT_DISPEL_MAGIC, urand(15000, 20000), 0);
                            break;
                        case EVENT_RENEW:
                            DoCast(me, SPELL_RENEW);
                            events.ScheduleEvent(EVENT_RENEW, urand(25000, 30000), 0);
                            break;
                        case EVENT_HOLY_NOVA:
                            ...
                            events.ScheduleEvent(EVENT_HOLY_NOVA, urand(45000, 75000), 0);
                            break;
                        case EVENT_HOLY_FIRE:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                                DoCast(target, SPELL_HOLY_FIRE);
                            events.ScheduleEvent(EVENT_HOLY_FIRE, urand(45000, 60000), 0);
                            break;
                        case EVENT_HOLY_WRATH:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                                DoCast(target, SPELL_HOLY_WRATH);
                            events.ScheduleEvent(EVENT_HOLY_WRATH, urand(45000, 60000), 0);
                            break;
                        ...
                        case EVENT_VENOM_SPIT:
                            ...
                            events.ScheduleEvent(EVENT_VENOM_SPIT, urand(5000, 15000), 0);
                            break;
                        case EVENT_POISON_CLOUD:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                                DoCast(target, SPELL_POISON_CLOUD);
                            events.ScheduleEvent(EVENT_POISON_CLOUD, urand(15000, 20000), 0);
                            break;
                        case EVENT_PARASITIC_SERPENT:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM))
                                DoCast(target, SPELL_SUMMON_PARASITIC_SERPENT);
                            events.ScheduleEvent(EVENT_PARASITIC_SERPENT, 15000, 0);
                            break;
                        case EVENT_FRENZY:
                            // frenzy at 20% health
                        ...
                        case EVENT_TRANSFORM:
                            ...
                            events.ScheduleEvent(EVENT_VENOM_SPIT, 5000, 0);
                            events.ScheduleEvent(EVENT_POISON_CLOUD, 10000, 0);
                            events.ScheduleEvent(EVENT_PARASITIC_SERPENT, 30000, 0);
