    ...
    public:
        ...
        class spell_love_is_in_the_air_romantic_picnic_AuraScript : public AuraScript
        {
            ...
            void OnPeriodic(AuraEffect const* /*aurEff*/)
            {
                ...
                Infinity::AnyPlayerInObjectRangeCheck checker(target, INTERACTION_DISTANCE*2);
                Infinity::PlayerListSearcher<Infinity::AnyPlayerInObjectRangeCheck> searcher(target, playerList, checker);
