...
typedef Infinity::AutoPtr<ACE_Configuration_Heap, ACE_Null_Mutex> Config;
...
public:
    /// Method used only for loading main configuration files (authserver.conf and InfinityWorld.conf)
