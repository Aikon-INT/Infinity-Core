...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_RELOAD_INFINITY_STRING                  = 704,
...
class RBACData
{
    public:
         ...
         *     IC_LOG_DEBUG("entities.player", "Failed to grant permission %u, already denied", permissionId);
         * @endcode
         */
         ...
         *     IC_LOG_DEBUG("entities.player", "Role Id %u does not exists", permissionId);
         * @endcode
         */
         ...
         *     IC_LOG_DEBUG("entities.player", "Permission %u succesfully removed", permissionId);
         * @endcode
         */
