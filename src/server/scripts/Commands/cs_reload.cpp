...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "infinity_string",                rbac::RBAC_PERM_COMMAND_RELOAD_INFINITY_STRING, true,  &HandleReloadInfinityStringCommand,              "", NULL },
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadInfinityStringCommand(handler, "");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        IC_LOG_INFO("misc", "Re-Loading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        IC_LOG_INFO("misc", "Re-Loading Scripts...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading config settings...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Access Requirement definitions...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Tavern Area Triggers...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading AreaTrigger teleport definitions...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Autobroadcasts...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading creature award reputation definitions...");
    ...
    {
        IC_LOG_INFO("misc", "Reloading creature summon groups...");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            IC_LOG_INFO("misc", "Reloading creature template entry %u", entry);
    ...
    {
        IC_LOG_INFO("misc", "Loading Quests Relations... (`creature_queststarter`)");
    ...
    {
        IC_LOG_INFO("misc", "Loading Linked Respawns... (`creature_linked_respawn`)");
    ...
    {
        IC_LOG_INFO("misc", "Loading Quests Relations... (`creature_questender`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `gossip_menu` Table!");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `gossip_menu_option` Table!");
    ...
    {
        IC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_queststarter`)");
    ...
    {
        IC_LOG_INFO("misc", "Loading Quests Relations... (`gameobject_questender`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Quest Area Triggers...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Quest Templates...");
        sObjectMgr->LoadQuests();
        handler->SendGlobalGMSysMessage("DB table `quest_template` (quest definitions) reloaded.");

        /// dependent also from `gameobject` but this table not reloaded anyway
        IC_LOG_INFO("misc", "Re-Loading GameObjects for quests...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`creature_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`fishing_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`gameobject_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`item_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`milling_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`pickpocketing_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`prospecting_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`mail_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`reference_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`skinning_loot_template`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    static bool HandleReloadInfinityStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        IC_LOG_INFO("misc", "Re-Loading infinity_string Table!");
        sObjectMgr->LoadInfinityStrings();
    ...
    static bool HandleReloadWardenactionCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        IC_LOG_INFO("misc", "Re-Loading warden_action Table!");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `npc_trainer` Table!");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `npc_vendor` Table!");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `points_of_interest` Table!");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Quest POI ..." );
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `npc_spellclick_spells` Table!");
    ...
    {
        IC_LOG_INFO("misc", "Loading ReservedNames... (`reserved_name`)");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `reputation_reward_rate` Table!" );
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading `reputation_spillover_template` Table!" );
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Skill Discovery Table...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Skill Extra Item Table...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Skill Fishing base level requirements...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading SpellArea Data...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Required Data... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Groups...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Learn Spells...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Linked Spells...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Proc Event conditions...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Proc conditions and data...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Bonus Data...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell target coordinates...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Aggro Spells Definitions...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell Group Stack Rules...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Spell pet auras...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Page Texts...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Item Random Enchantments Table...");
 ...
 /*   {
        IC_LOG_INFO("misc", "Re-Loading Item set names...");
...
*/
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            IC_LOG_INFO("misc", "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            IC_LOG_INFO("misc", "Re-Loading Scripts from `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            IC_LOG_INFO("misc", "Re-Loading Waypoints data from 'waypoints_data'");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            IC_LOG_INFO("misc", "Re-Loading Scripts from `spell_scripts`...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Script strings from `db_script_string`...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Graveyard-zone links...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Game Tele coordinates...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading disables table...");
        DisableMgr::LoadDisables();
        IC_LOG_INFO("misc", "Checking quest disables...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Creature ...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Creature Texts...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Gameobject ... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Gossip Menu Option ... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Item ... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Item set name... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales NPC Text ... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Page Text ... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Points Of Interest ... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Locales Quest ... ");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Player level dependent mail rewards...");
    ...
    static bool HandleReloadAuctionsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        IC_LOG_INFO("misc", "Re-Loading Auctions...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Conditions...");
        sConditionMgr->LoadConditions(true);
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Creature Texts...");
    ...
    {
        IC_LOG_INFO("misc", "Re-Loading Smart Scripts...");
    ...
    {
        IC_LOG_INFO("misc", "Reloading RBAC tables...");
