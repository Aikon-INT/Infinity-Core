        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
                ...
                Infinity::AllWorldObjectsInRange objects(me, searchDistance);
                Infinity::WorldObjectListSearcher<Infinity::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
