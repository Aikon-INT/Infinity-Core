...
class BattlegroundMgr
{
    ...
    public:
        ...
        Battleground* CreateNewBattleground(BattlegroundTypeId bgTypeId, uint8 arenaType, bool isRated);
        ...
        void ScheduleQueueUpdate(uint32 arenaMatchmakerRating, uint8 arenaType, BattlegroundQueueTypeId bgQueueTypeId, BattlegroundTypeId bgTypeId);
