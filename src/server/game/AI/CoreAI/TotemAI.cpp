...
void TotemAI::UpdateAI(uint32 /*diff*/)
{
    ...
    {
        victim = NULL;
        Infinity::NearestAttackableUnitInObjectRangeCheck u_check(me, me, max_range);
        Infinity::UnitLastSearcher<Infinity::NearestAttackableUnitInObjectRangeCheck> checker(me, victim, u_check);
