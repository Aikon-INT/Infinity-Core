...
void WorldSession::HandleChannelJoin(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_JOIN_CHANNEL %s Channel: %u, unk1: %u, unk2: %u, channel: %s, password: %s",
...
void WorldSession::HandleChannelLeave(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_LEAVE_CHANNEL %s Channel: %s, unk1: %u",
...
void WorldSession::HandleChannelList(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "%s %s Channel: %s",
...
void WorldSession::HandleChannelPassword(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_PASSWORD %s Channel: %s, Password: %s",
...
void WorldSession::HandleChannelSetOwner(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_SET_OWNER %s Channel: %s, Target: %s",
...
void WorldSession::HandleChannelOwner(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_OWNER %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
...
void WorldSession::HandleChannelModerator(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_MODERATOR %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmoderator(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMODERATOR %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelMute(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_MUTE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmute(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNMUTE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelInvite(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_INVITE %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelKick(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_KICK %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelBan(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_BAN %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnban(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_UNBAN %s Channel: %s, Target: %s",
        GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelAnnounce(WorldPacket& recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_CHANNEL_ANNOUNCEMENTS %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
...
void WorldSession::HandleChannelInfoQuery(WorldPacket &recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_GET_CHANNEL_MEMBER_COUNT %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
    ...
    if (ChannelMgr* cMgr = ChannelMgr::forTeam(GetPlayer()->GetTeam()))
    {
        if (Channel* channel = cMgr->GetChannel(channelName, GetPlayer()))
        {
            IC_LOG_DEBUG("chat.system", "SMSG_CHANNEL_MEMBER_COUNT %s Channel: %s Count: %u",
...
void WorldSession::HandleSetChannelWatch(WorldPacket &recvPacket)
{
    ...
    IC_LOG_DEBUG("chat.system", "CMSG_SET_CHANNEL_WATCH %s Channel: %s",
        GetPlayerInfo().c_str(), channelName.c_str());
}*/
