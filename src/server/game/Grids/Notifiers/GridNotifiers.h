...
#ifndef INFINITY_GRIDNOTIFIERS_H
#define INFINITY_GRIDNOTIFIERS_H
...
namespace Infinity
{
    ...
    struct WorldObjectSearcher
    {
        ...
        WorldObjectSearcher(WorldObject const* searcher, WorldObject* & result, Check& check, uint32 mapTypeMask = GRID_MAP_TYPE_MASK_ALL)
            : i_mapTypeMask(mapTypeMask), i_object(result), i_check(check) { }
    ...
    struct WorldObjectListSearcher
    {
        ...
        WorldObjectListSearcher(WorldObject const* searcher, std::list<WorldObject*> &objects, Check & check, uint32 mapTypeMask = GRID_MAP_TYPE_MASK_ALL)
            : i_mapTypeMask(mapTypeMask), i_objects(objects), i_check(check) { }
    ...
    struct WorldObjectWorker
    {
        ...
        WorldObjectWorker(WorldObject const* searcher, Do const& _do, uint32 mapTypeMask = GRID_MAP_TYPE_MASK_ALL)
            : i_mapTypeMask(mapTypeMask), i_do(_do) { }
    ...
    struct PlayerLastSearcher
    {
        ...
        PlayerLastSearcher(WorldObject const* searcher, Player*& result, Check& check) : i_object(result), i_check(check)
        {
        }
