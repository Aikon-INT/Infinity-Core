# ![logo](http://www.trinitycore.org/f/public/style_images/1_trinitycore.png) InfinityCore


## Introduction

InfinityCore is a *MMORPG* Framework based mostly in C++.
...
make pull requests to our [Github repository](https://github.com/InfinityCore/InfinityCore).

For further information on the InfinityCore project, please visit our project
website at [InfinityCore.org](http://www.trinitycore.org).
...
Issues can be reported via the [Github issue tracker](https://github.com/InfinityCore/InfinityCore/issues?labels=Branch-3.3.5a).
