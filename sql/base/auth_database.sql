...
INSERT INTO `realmlist` VALUES (1,'Infinity','127.0.0.1','127.0.0.1','255.255.255.0',8085,1,0,1,0,0,8606);
...
CREATE TABLE `uptime` (
  ...
  `revision` varchar(255) NOT NULL DEFAULT 'Infinitycore',
