...
#ifndef INFINITY_OBJECTACCESSOR_H
#define INFINITY_OBJECTACCESSOR_H
...
class HashMapHolder
{
    public:
        ...
        {
            INFINITY_WRITE_GUARD(LockType, i_lock);
        ...
        {
            INFINITY_READ_GUARD(LockType, i_lock);
...
class ObjectAccessor
{
    ...
    public:
        ...
        {
            INFINITY_GUARD(ACE_Thread_Mutex, i_objectLock);
