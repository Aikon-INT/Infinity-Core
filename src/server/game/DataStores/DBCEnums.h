...
enum SpawnMask
{
    ...
    SPAWNMASK_RAID_10MAN_HEROIC = (1 << RAID_DIFFICULTY_HEROIC)
...
enum SummonPropFlags
{
    ...
    SUMMON_PROP_FLAG_UNK16           = 0x00008000           // Light/Dark Bullet, Soul/Fiery Consumption, Twisted Visage, Twilight Whelp. 
};
