...
public:
    ...
    public:
        ...
        void IsSummonedBy(Unit* /*summoner*/) OVERRIDE
        {
            ...
            Infinity::AnyPlayerInObjectRangeCheck checker(me, 5.0f);
            Infinity::PlayerListSearcher<Infinity::AnyPlayerInObjectRangeCheck> searcher(me, playerOnQuestList, checker);
